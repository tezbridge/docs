...
<style scoped>
button { margin-bottom: 8px; transition: all 0.2s; cursor: pointer; border: 2px solid #85b5ca; padding: 4px 8px; border-radius: 4px; background: #e8eff7; color: #496998; outline: none;}
button:hover { color: white; background: #85b5ca }
